                        ...
                        <div className="tab-pane fade" id="client" role="tabpanel" aria-labelledby="client-tab">
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <button onClick={() => this.handleContactCallSubmit("CCD")} value="CPD" className="btn btn-primary">Answered, No appointment</button>
                                    <button onClick={() => this.handleScheduledApptSubmit("CCD")} value="CPD" className="btn btn-primary">Scheduled Appointment</button>
                                ...
                                <div className="col-md-6">
                                    ...
                                    <button onClick={() => this.handleContactCallSubmit("BCD")} value="CPD" className="btn btn-primary">Answered, No appointment</button>
                                    <button onClick={() => this.handleScheduledApptSubmit("BCD")} value="CPD" className="btn btn-primary">Scheduled Appointment</button>
                        ...
                        <div className="tab-pane fade" id="natural" role="tabpanel" aria-labelledby="natural-tab">
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <button onClick={() => this.handleContactCallSubmit("CND")} value="CPD" className="btn btn-primary">Answered, No appointment</button>
                                    <button onClick={() => this.handleScheduledApptSubmit("CND")} value="CPD" className="btn btn-primary">Scheduled Appointment</button>
                                </div>
                                <hr />
                                <br />
                                <div className="col-md-6">
                                    ...
                                    <button onClick={() => this.handleContactCallSubmit("BND")} value="CPD" className="btn btn-primary">Answered, No appointment</button>
                                    <button onClick={() => this.handleScheduledApptSubmit("BND")} value="CPD" className="btn btn-primary">Scheduled Appointment</button>
                                </div>
                            </div>
